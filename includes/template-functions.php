 ...
 *
 * @uses  bok_locate_template()
 * @uses  load_template()
 * @uses  get_template_part()
 */
function bok_get_template_part( $slug, $name = null, $load = true, $template_vars ) {
	...
	$templates = apply_filters( 'bok_get_template_part', $templates, $slug, $name );
 
	// Return the part that is found
	bok_locate_template( $templates, $load, false, $template_vars );
}
